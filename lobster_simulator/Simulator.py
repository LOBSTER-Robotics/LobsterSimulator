...
class Simulator:
    ...
    def __init__(self, time_step: int, model=Models.SCOUT_ALPHA, config=None, gui=True):
        ...
        PybulletAPI.initialize(self.time_step, gui)

        self.simulator_frequency_slider = PybulletAPI.addUserDebugParameter("simulation frequency", 10, 1000,
                                                                            1 / self.time_step.microseconds)
        self.buoyancy_force_slider = PybulletAPI.addUserDebugParameter("buoyancyForce", 0, 1000, 550)
